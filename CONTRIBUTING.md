...
includes [TypeScript path aliases](./tsconfig.json) (e.g: scripts in the
[`scripts`](./scripts) directory).

##### Conditionally require `tsconfig-paths/register`
...
4. Run your script:
   ...
   ```zsh
   NODE_OPTIONS='-r tsconfig-paths/register' yarn build
   ```
