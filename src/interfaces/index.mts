...
export type { default as LogFunction } from '#interfaces/log-function'
export type { default as LogFunctions } from '#interfaces/log-functions'
export type { default as LogLevelMap } from '#interfaces/log-level-map'
export type { default as LogObject } from '#interfaces/log-object'
